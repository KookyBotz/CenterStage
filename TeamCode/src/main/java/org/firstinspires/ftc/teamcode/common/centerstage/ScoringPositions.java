...
public class ScoringPositions {
    ...
    public static final ScoringPosition[] YELLOW_PIXEL_POSITIONS = {
            ...
            new ScoringPosition(new Pose(-30.75, -35.25, 0), extension, armAngle, ClawSide.LEFT), // RED LEFT RIGHT
            new ScoringPosition(new Pose(-32.25, -35.25, 0), extension, armAngle, ClawSide.BOTH), // RED CENTER LEFT
            new ScoringPosition(new Pose(-36.25, -35.25, 0), extension, armAngle, ClawSide.LEFT), // RED CENTER RIGHT
            new ScoringPosition(new Pose(-38.75, -35.25, 0), extension, armAngle, ClawSide.BOTH), // RED RIGHT LEFT
            new ScoringPosition(new Pose(-42.75, -35.25, 0), extension, armAngle, ClawSide.LEFT), // RED RIGHT RIGHT
    };
